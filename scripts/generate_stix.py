...
Unmodified from AmnestyTech/investigations. Reads domains.txt, files.txt,
processes.txt, and emails.txt from the current working directory and builds
pegasus.stix2 in the current working directory.

Not project-authored -- kept here verbatim as a dev/test utility so
`pnpm gen:fake-stix` can drive the real Amnesty tooling against synthetic
fixtures produced by generate_fake_iocs.py. If Amnesty's upstream copy
changes, re-sync this file rather than editing it locally.
"""
import sys
import os
